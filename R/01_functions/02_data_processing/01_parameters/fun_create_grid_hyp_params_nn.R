...
# create grid of values of hyperparameters for RNN model
...
fun_create_grid_hyp_params_nn <- function(number_hyp_par_grid,
  ...
  if (!(file.exists(path_output_parameter_grid)) | do_new) {
    ...
    if (!(file.exists(paste0(Directory_Parameters, Subdirectory_Parameters_Hyperparameters, "rnn/", number_hyp_par_grid)))) {
      ...
      dir.create(file.path(paste0(Directory_Parameters, Subdirectory_Parameters_Hyperparameters, "rnn/", number_hyp_par_grid)))
      
    }
    
    # remove files inside the directory where output will be stored
    if (length(list.files(path = paste0(Directory_Parameters, Subdirectory_Parameters_Hyperparameters, "rnn/", number_hyp_par_grid))) > 0) {
      
      file.remove(paste0(Directory_Parameters, Subdirectory_Parameters_Hyperparameters, "rnn/", number_hyp_par_grid, "/",
                         list.files(path = paste0(Directory_Parameters, Subdirectory_Parameters_Hyperparameters, "rnn/", number_hyp_par_grid))))
