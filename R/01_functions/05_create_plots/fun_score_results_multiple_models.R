...
score_results_multiple_models <- function(list_models = c("lr", "rnn", "lstm", "xgb"),
  ...
  for (aa in 1:length(list_numbers_grid_combinations_kNp_dates_train_test)) {
    ...
    results_locf <- results_locf %>%
      filter(group_dates_train_test == list_groups_dates_train_test[aa]) %>%
  ...
  ggsave(plot = plot_best_model_minimum_datasets_score_test,
         filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "best_performance/plot_results_best_model_minimum_XY_", number_xy, "_PD_",
  ...
  ggsave(plot = plot_best_dataset_minimum_models_score_test,
         filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "best_performance/plot_results_best_dataset_minimum_XY_", number_xy, "_PD_",
                           paste(list_numbers_grid_combinations_kNp_dates_train_test, collapse = '_'), "_D_", paste(list_groups_dates_train_test, collapse = '_'), "_score_test", name_ending, ".pdf"),
         width = 11.7, height = 5, units = c("in"))
  ...
  ggsave(plot = plot_grid_best_model_best_dataset_minimum,
         filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "best_performance/plot_results_best_model_dataset_minimum_XY_", number_xy, "_PD_",
                           paste(list_numbers_grid_combinations_kNp_dates_train_test, collapse = '_'), "_D_", paste(list_groups_dates_train_test, collapse = '_'), "_score_test", name_ending, ".pdf"),
  ...
  ggsave(plot = plot_best_model_average_datasets_score_test,
         filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "average_performance/plot_results_best_model_average_XY_", number_xy, "_PD_",
                           paste(list_numbers_grid_combinations_kNp_dates_train_test, collapse = '_'), "_D_", paste(list_groups_dates_train_test, collapse = '_'), "_score_test", name_ending, ".pdf"),
         width = 11.7, height = 5, units = c("in"))
  ...
  ggsave(plot = plot_best_dataset_average_models_score_test,
         filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "average_performance/plot_results_best_dataset_average_XY_", number_xy, "_PD_",
                           paste(list_numbers_grid_combinations_kNp_dates_train_test, collapse = '_'), "_D_", paste(list_groups_dates_train_test, collapse = '_'), "_score_test", name_ending, ".pdf"),
         width = 11.7, height = 5, units = c("in"))
  ...
  ggsave(plot = plot_grid_best_model_best_dataset_average,
         filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "average_performance/plot_results_best_model_dataset_average_XY_", number_xy, "_PD_",
                           paste(list_numbers_grid_combinations_kNp_dates_train_test, collapse = '_'), "_D_", paste(list_groups_dates_train_test, collapse = '_'), "_score_test", name_ending, ".pdf"),
         width = 7.3, height = 7.3, units = c("in"))
