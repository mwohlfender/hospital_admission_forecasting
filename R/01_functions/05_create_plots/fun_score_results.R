...
score_results <- function(list_models = c("lr", "rnn", "lstm", "xgb"),
                          filter_datasets = c(),
                          number_xy = "001",
  ...
  results_locf <- read_csv(file = get_path_results_processed_summary(type_model = "locf",
                                                                     number_xy = number_xy,
  ...
  for (ii in 1:length(list_models)) {
    ...
    if (length(list_files_results_model_ii) > 0) {
  ...
  ggsave(plot = plot_results_models_overview_score_train,
         filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "overview/train/plot_results_models_overview_XY_", number_xy, "_PD_",
  ...
  ggsave(plot = plot_results_models_overview_score_test,
         filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "overview/test/plot_results_models_overview_XY_", number_xy, "_PD_",
  ...
  if (length(unique(results_models_summarized_model_dataset_kNp$label_dataset)) > 6) {
    ...
    for (ii in 1:ceiling(length(list_label_dataset)/6)) {
      ...
      if (!(is.null(plot_supplementary))) {
        ...
        ggsave(plot = plot_results_models_overview_score_test,
               filename = paste0(Directory_Plots, Subdirectory_Plots_Supplementary, plot_supplementary[1], "_", letters[ii], ".pdf"),
               width = 7.3, height = ((min(ii*6, length(list_label_dataset))) - ((ii-1)*6+1) + 1)/6 * 9 + 1.6, units = c("in"))
  ...
  #        filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "average_performance/plot_results_models_average_XY_", number_xy, "_PD_",
  #                          number_grid_combinations_kNp_dates_train_test, "_D_", group_dates_train_test, "_score_test", name_ending, ".pdf"),
  ...
  #        filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "average_performance/plot_results_datasets_average_XY_", number_xy, "_PD_",
  #                          number_grid_combinations_kNp_dates_train_test, "_D_", group_dates_train_test, "_score_test", name_ending, ".pdf"),
  #        width = 7.3, units = c("in"))
  ...
  ggsave(plot = plot_grid_models_datasets_average,
         filename = paste0(Directory_Plots, Subdirectory_Plots_Results, "average_performance/plot_results_model_dataset_average_XY_", number_xy, "_PD_",
                           number_grid_combinations_kNp_dates_train_test, "_D_", group_dates_train_test, "_score_test", name_ending, ".pdf"),
  ...
  if (!(is.null(plot_supplementary))) {
    ...
    ggsave(plot = plot_grid_models_datasets_average,
           filename = paste0(Directory_Plots, Subdirectory_Plots_Supplementary, plot_supplementary[2], ".pdf"),
           width = 7.3, height = 9.7, units = c("in"))
