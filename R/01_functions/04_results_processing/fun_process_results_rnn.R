...
process_results_rnn <- function(number_job_array,
  ...
  directory_results_forecasts_rnn_train <- get_path_results_forecasts(directory_results = directory_results,
                                                                      type_model = "rnn",
                                                                      number_xy = number_xy,
  ...
  directory_results_forecasts_rnn_test <- get_path_results_forecasts(directory_results = directory_results,
                                                                     type_model = "rnn",
                                                                     number_xy = number_xy,
                                                                     number_combination_features = number_combination_features,
                                                                     name_data_set = name_data_set,
