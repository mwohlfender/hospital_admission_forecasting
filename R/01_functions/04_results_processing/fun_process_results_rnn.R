...
process_results_rnn <- function(number_job_array,
  ...
  directory_results_forecasts_rnn_train <- get_path_results_forecasts(directory_results = directory_results_processed,
                                                                      type_model = "rnn",
                                                                      number_xy = number_xy,
  ...
  directory_results_forecasts_rnn_test <- get_path_results_forecasts(directory_results = directory_results_processed,
                                                                     type_model = "rnn",
                                                                     number_xy = number_xy,
                                                                     number_combination_features = number_combination_features,
                                                                     name_data_set = name_data_set,
  ...
  if (!(file.exists(directory_results_forecasts_rnn_train))) {
    
    dir.create(file.path(directory_results_forecasts_rnn_train), recursive = TRUE)
    
  }
  
  if (!(file.exists(directory_results_forecasts_rnn_test))) {
    
    dir.create(file.path(directory_results_forecasts_rnn_test), recursive = TRUE)
