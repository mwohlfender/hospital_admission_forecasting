...
process_results_xgb <- function(number_job_array,
  ...
  directory_results_processed_general <- get_path_results_raw(type_model = "xgb",
                                                              number_xy = number_xy,
  ...
  directory_results_processed_train <- get_path_results_raw(type_model = "xgb",
                                                            number_xy = number_xy,
                                                            number_combination_features = number_combination_features,
                                                            name_data_set = name_data_set,
                                                            number_combination_kNp = "NONE",
  ...
  directory_results_processed_test <- get_path_results_raw(type_model = "xgb",
                                                           number_xy = number_xy,
                                                           number_combination_features = number_combination_features,
                                                           name_data_set = name_data_set,
                                                           number_combination_kNp = "NONE",
