...
process_results_xgb <- function(number_job_array,
  ...
  directory_results_forecasts_xgb_train <- get_path_results_forecasts(directory_results = directory_results_processed,
                                                                      type_model = "xgb",
                                                                      number_xy = number_xy,
  ...
  directory_results_forecasts_xgb_test <- get_path_results_forecasts(directory_results = directory_results_processed,
                                                                     type_model = "xgb",
                                                                     number_xy = number_xy,
                                                                     number_combination_features = number_combination_features,
                                                                     name_data_set = name_data_set,
