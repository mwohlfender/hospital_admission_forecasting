...
data_features <- data_features %>% bind_rows(data_hospitalizations_base %>%
                                               mutate(type = "all",
                                                      color = "color_1",
...
data_features <- data_features %>% bind_rows(data_hospitalizations_age %>%
...
data_features <- data_features %>% bind_rows(data_features_001 %>%
                                               mutate(type = "001",
                                                      color = "color_2",
...
data_features <- data_features %>% bind_rows(data_features_002 %>%
                                               mutate(type = "002",
                                                      color = "color_2",
...
data_features <- data_features %>% bind_rows(data_features_004 %>%
                                               mutate(type = "004",
                                                      color = "color_3",
...
data_features <- data_features %>% bind_rows(data_features_005 %>%
                                               mutate(type = "005",
                                                      color = "color_2",
...
data_features <- data_features %>% bind_rows(data_features_006 %>%
                                               mutate(type = "006a",
                                                      color = "color_2",
...
data_features <- data_features %>% bind_rows(data_features_007 %>%
                                               mutate(type = "007a",
                                                      color = "color_2",
...
data_features <- data_features %>% bind_rows(data_features_008 %>%
                                               mutate(type = "008a",
                                                      color = "color_2",
