...
if (!(file.exists(Path_Data_Wastewater_Processed)) | Bool_Data_Processing_Do_New) {
  
  # read raw data
  data_wastewater_raw <- read_delim(file = Path_Data_Wastewater_Raw, delim = ";")
  ...
  write_csv(x = data_wastewater_processed_approx,
            file = Path_Data_Wastewater_Processed)
